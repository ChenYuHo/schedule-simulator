...
def keras_model_to_DAG(model, skipped_layer_types=None):
    ...
    # TODO replace skipped layer types by skip untrainable layers option
    ...
    units = {"{}comm_unit".format(LOCAL_EXTRA_PREFIX): "B", "{}forward_pass_unit".format(LOCAL_EXTRA_PREFIX): None,
             "{}backward_pass_unit".format(LOCAL_EXTRA_PREFIX): None, }
...
if __name__ == "__main__":
    ...
    with open("tensorflow_layer_name_mapping_profiling_reports/{}".format(report_name)) as report_file:
